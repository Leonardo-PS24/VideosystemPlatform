...
{
    /// <inheritdoc />
    public partial class AddKioskTables : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_KioskChecklistTemplates", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApplicationName = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    ...
                    GrantedBy = table.Column<string>(type: "TEXT", maxLength: 450, nullable: true),
            ...
            migrationBuilder.CreateTable(
                name: "KioskChecklistInstances",
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    TemplateId = table.Column<int>(type: "INTEGER", nullable: false),
                    MachineSerialNumber = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_KioskChecklistInstances", x => x.Id);
                    table.ForeignKey(
                        name: "FK_KioskChecklistInstances_KioskChecklistTemplates_TemplateId",
                        column: x => x.TemplateId,
                        principalTable: "KioskChecklistTemplates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_KioskChecklistInstances_TemplateId",
